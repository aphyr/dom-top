...
(defn mutable-acc-type
  ...
  TODO: someone clever-er than I please replace the use of insn here with plain
  old clojure.asm. I'm sure it can be done, I'm just not clever enough to
                       ...
                       :fields (map-indexed
                                 (fn [i type]
                                   {:flags #{:public}
                                    :name  (str "x" i)
                                    :type  (case type
                                             ; Valid Clojure type hints which
                                             ; we have to transform into string
                                             ; descriptors. Type-wise arrays
                                             ; are all objects, soooo...
